    ...
    <>
      ...
      <section className="bg-gray-50 section-padding">
        <div className="container-main max-w-4xl">
          <SectionHeading tag="Trajetória" title="Nossa Linha do Tempo" />
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {timeline.map((item, i) => (
                ...
                >
                  <div className="shrink-0 w-16 h-16 bg-primary rounded-2xl flex items-center justify-center relative z-10">
      ...
      <section className="bg-white section-padding">
        <div className="container-main">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <h3 className="font-bold text-dark text-lg mb-8">
                Nossos Valores
              </h3>
              <div className="space-y-4">
                {valores.map((v) => (
                  ...
                  >
                    ...
                    <span className="font-medium text-dark">{v.label}</span>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      <section className="bg-gray-50 section-padding">
        <div className="container-main">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.08 }}
                    className="bg-white rounded-2xl p-5 shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300"
                  >
                    <div className="flex items-center gap-3">
                      <FaMapMarkerAlt className="text-lime shrink-0" />
                      <div>
                        <h3 className="font-bold text-dark text-sm">{item.regiao}</h3>
                        <p className="text-gray-400 text-xs mt-0.5">{item.cidades}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <motion.div
              {...fadeUp}
              className="bg-forest rounded-3xl p-10 text-center aspect-square flex items-center justify-center"
            >
              <div>
